...
export const FISH_SPECIES = [
  // ── 潮だまり（通常10種）──
  { id: "tide-goby", name: "マハゼ", habitat: "潮だまり", regionId: "tidepool", stages: ["S00"], color: "#c79a5a", accent: "#f2e4c2", shape: "round", depth: "floor", sprite: { src: "/sprites/mahaze-strip.png", frames: 4, frameMs: 300, sourceFacing: "right" } },
  { id: "tide-shrimp", name: "イソスジエビ", habitat: "潮だまり", regionId: "tidepool", stages: ["S00"], color: "#e0a58f", accent: "#ffe8d6", shape: "long", depth: "bottom", sprite: { src: "/sprites/iso-suji-shrimp-strip.png", frames: 4, frameMs: 300, sourceFacing: "right" } },
  { id: "left-damselfish", name: "ソラスズメダイ", habitat: "潮だまり", regionId: "tidepool", stages: ["S01", "S02", "S03"], color: "#3f7fd6", accent: "#d7e8ff", shape: "round", school: true, sprite: { src: "/sprites/neon-damselfish-strip.png", frames: 4, frameMs: 260, sourceFacing: "right" } },
  ...
  { id: "coral-fish", name: "オヤビッチャ", habitat: "潮だまり", regionId: "tidepool", stages: ["S04", "S05", "S06"], color: "#d8c48c", accent: "#4f6f6a", shape: "round", school: true, sprite: { src: "/sprites/oyabiccha-strip.png", frames: 4, frameMs: 280, sourceFacing: "right" } },
  { id: "sea-glassfish", name: "キビナゴ", habitat: "潮だまり", regionId: "tidepool", stages: ["S04", "S05", "S06"], color: "#8fb8cf", accent: "#eef6fb", shape: "long", school: true, depth: "top", sprite: { src: "/sprites/kibinago-strip.png", frames: 4, frameMs: 240, sourceFacing: "right" } },
  { id: "grass-seahorse", name: "タツノオトシゴ", habitat: "潮だまり", regionId: "tidepool", stages: ["S07", "S08"], color: "#91ae70", accent: "#f3e6a1", shape: "tall", movement: "drift", depth: "bottom", sprite: { src: "/sprites/crowned-seahorse-strip.png", frames: 4, frameMs: 340, sourceFacing: "right" } },
  { id: "moon-squid", name: "コウイカ", habitat: "潮だまり", regionId: "tidepool", stages: ["S07", "S08"], color: "#b6a2ca", accent: "#e9e6f5", shape: "tall", movement: "drift", depth: "top", scale: 1.2, sprite: { src: "/sprites/golden-cuttlefish-strip.png", frames: 4, frameMs: 320, sourceFacing: "right" } },
  ...
  { id: "ribbon-eel", name: "ハナヒゲウツボ", habitat: "浅瀬", regionId: "shallows", stages: ["SH05", "SH06"], color: "#4f7fd6", accent: "#ffd24a", shape: "long", depth: "bottom", scale: 1.35, sprite: { src: "/sprites/ribbon-eel-strip.png", frames: 4, frameMs: 300, sourceFacing: "right" } },
  { id: "bubble-jelly", name: "タコクラゲ", habitat: "浅瀬", regionId: "shallows", stages: ["SH07"], color: "#ef8fa5", accent: "#ffe4eb", shape: "tall", movement: "drift", depth: "top", sprite: { src: "/sprites/spotted-jelly-strip.png", frames: 4, frameMs: 360, sourceFacing: "right" } },
  { id: "shell-octopus", name: "マダコ", habitat: "浅瀬", regionId: "shallows", stages: ["SH08", "SH09"], color: "#d67b68", accent: "#ffe0c7", shape: "round", depth: "bottom", scale: 1.3, sprite: { src: "/sprites/madako-strip.png", frames: 4, frameMs: 320, sourceFacing: "right" } },
  { id: "sun-threadfish", name: "イトヒキアジ", habitat: "浅瀬", regionId: "shallows", stages: ["SH10", "SH11"], color: "#cdd8e2", accent: "#f4f9fd", shape: "long", school: true, sprite: { src: "/sprites/threadfin-jack-strip.png", frames: 4, frameMs: 300, sourceFacing: "right" } },
  { id: "shallow-garden-eel", name: "チンアナゴ", habitat: "浅瀬", regionId: "shallows", stages: ["SH03", "SH04", "SH05"], color: "#e6dcc4", accent: "#8a7a5a", shape: "tall", movement: "anchor", depth: "floor", sprite: { src: "/sprites/spotted-garden-eel-strip.png", frames: 4, frameMs: 360, sourceFacing: "right" } },
